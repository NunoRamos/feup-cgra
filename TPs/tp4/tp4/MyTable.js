...
//	this.materialD.setSpecular(1,1,1,1);	
	...
	this.tableMaterial = new CGFappearance(this.scene);
	this.tableMaterial.setSpecular(0.1, 0.1, 0.1, 1);
	this.tableMaterial.setShininess(1);
	this.tableMaterial.setDiffuse(1, 1, 1, 1);
	this.tableMaterial.loadTexture("../resources/images/table.png");
